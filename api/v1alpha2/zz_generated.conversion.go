...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*BMC)(nil), (*v1alpha3.BMC)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_BMC_To_v1alpha3_BMC(a.(*BMC), b.(*v1alpha3.BMC), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha3.BMC)(nil), (*BMC)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_BMC_To_v1alpha2_BMC(a.(*v1alpha3.BMC), b.(*BMC), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_BMC_To_v1alpha3_BMC(in *BMC, out *v1alpha3.BMC, s conversion.Scope) error {
...
// Convert_v1alpha2_BMC_To_v1alpha3_BMC is an autogenerated conversion function.
func Convert_v1alpha2_BMC_To_v1alpha3_BMC(in *BMC, out *v1alpha3.BMC, s conversion.Scope) error {
	return autoConvert_v1alpha2_BMC_To_v1alpha3_BMC(in, out, s)
}

func autoConvert_v1alpha3_BMC_To_v1alpha2_BMC(in *v1alpha3.BMC, out *BMC, s conversion.Scope) error {
	out.Endpoint = in.Endpoint
	out.User = in.User
	out.Pass = in.Pass
	return nil
...
// Convert_v1alpha3_BMC_To_v1alpha2_BMC is an autogenerated conversion function.
func Convert_v1alpha3_BMC_To_v1alpha2_BMC(in *v1alpha3.BMC, out *BMC, s conversion.Scope) error {
	return autoConvert_v1alpha3_BMC_To_v1alpha2_BMC(in, out, s)
}
...
func autoConvert_v1alpha2_MetalMachineSpec_To_v1alpha3_MetalMachineSpec(in *MetalMachineSpec, out *v1alpha3.MetalMachineSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha2_BMC_To_v1alpha3_BMC(&in.BMC, &out.BMC, s); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_MetalMachineSpec_To_v1alpha2_MetalMachineSpec(in *v1alpha3.MetalMachineSpec, out *MetalMachineSpec, s conversion.Scope) error {
	out.ProviderID = (*string)(unsafe.Pointer(in.ProviderID))
	if err := Convert_v1alpha3_BMC_To_v1alpha2_BMC(&in.BMC, &out.BMC, s); err != nil {
		return err
	}
	out.ServerRef = (*v1.ObjectReference)(unsafe.Pointer(in.ServerRef))
	return nil
...
func autoConvert_v1alpha2_MetalMachineTemplateList_To_v1alpha3_MetalMachineTemplateList(in *MetalMachineTemplateList, out *v1alpha3.MetalMachineTemplateList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1alpha3.MetalMachineTemplate)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1alpha3_MetalMachineTemplateList_To_v1alpha2_MetalMachineTemplateList(in *v1alpha3.MetalMachineTemplateList, out *MetalMachineTemplateList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]MetalMachineTemplate)(unsafe.Pointer(&in.Items))
	return nil
}
